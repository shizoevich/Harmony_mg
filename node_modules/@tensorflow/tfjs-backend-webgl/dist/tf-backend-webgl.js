...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function getLogicalCoordinatesFromFlatIndexByUniform(coords, shape, index) {
        if (index === void 0) { index = 'index'; }
        var strides = tf.util.computeStrides(shape);
        return strides
            .map(function (_, i) {
    ...
    function getOutput3DCoords(shape, texShape, enableShapeUniforms) {
        if (enableShapeUniforms) {
            var coordsFromIndexSnippet_1 = getLogicalCoordinatesFromFlatIndexByUniform(['r', 'c', 'd'], shape);
    ...
    function getOutput4DCoords(shape, texShape, enableShapeUniforms) {
        if (enableShapeUniforms) {
            var coordsFromIndexSnippet_2 = getLogicalCoordinatesFromFlatIndexByUniform(['r', 'c', 'd', 'd2'], shape);
    ...
    function getUniformInfoFromShape(isPacked, shape, texShape) {
        var newShape = tf.util.squeezeShape(shape).newShape;
        var rank = shape.length;
        ...
        return { useSqueezeShape: useSqueezeShape, uniformShape: uniformShape };
    }
    ...
    function makeShaderKey(program, inputs, output) {
        ...
        inputs.concat(output).forEach(function (x) {
            ...
            if (program.enableShapeUniforms && !x.isUniform) {
                ...
                var _a = getUniformInfoFromShape(program.packedInputs, x.shape, xTexShape), useSqueezeShape = _a.useSqueezeShape, uniformShape = _a.uniformShape;
                ...
                var isLogicalShapTexShapeEqual = xRank === 2 && tf.util.arraysEqual(x.shape, xTexShape);
                ...
                var isTexShapeGreaterThanOne = program.packedInputs || xRank > 2 ?
                    '' :
    ...
    var MathBackendWebGL = /** @class */ (function (_super) {
        ...
        MathBackendWebGL.prototype.packedReshape = function (input, afterShape) {
            ...
            var output = this.runWebGLProgram(program, [input3D], input.dtype, null /* customUniformValues */, preventEagerUnpackingOfOutput);
        ...
        MathBackendWebGL.prototype.decode = function (dataId) {
            ...
            var preventEagerUnpackingOfOutput = true;
            var out = this.runWebGLProgram(program, [{ shape: shapeAs3D, dtype: dtype, dataId: dataId }], dtype, null /* customUniformValues */, preventEagerUnpackingOfOutput);
